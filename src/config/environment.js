...
const environment = {
  ...
  // Base de donnees
  MONGODB_URI: process.env.MONGODB_URI || 'mongodb://localhost:27017/chez_roger_becker',
  ...
  REFRESH_TOKEN_SECRET: process.env.REFRESH_TOKEN_SECRET || 'dev_refresh_jwt_secret_chez_roger_becker_change_in_prod_min32',
...
if (environment.isProduction) {
  const criticalVars = ['MONGODB_URI', 'JWT_SECRET', 'REFRESH_TOKEN_SECRET', 'COOKIE_SECRET'];
